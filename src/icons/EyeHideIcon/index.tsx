...
export default function EyeHideIcon({ width = "20px", height = "20px", className }: IconPropsTypeInterface) {
	return (
		<svg fill='none' viewBox='0 0 20 10' width={width} height={height} className={className}>
			<path
				stroke='none'
				fill='#000'
				fillOpacity='.54'
