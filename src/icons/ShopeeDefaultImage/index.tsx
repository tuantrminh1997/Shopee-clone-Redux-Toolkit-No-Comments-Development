...
export default function ShopeeDefaultImage({ width = "120px", height = "120px" }: IconPropsTypeInterface) {
	return (
		<svg width={width} height={height} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 54 61' fill='#e5e4e4'>
