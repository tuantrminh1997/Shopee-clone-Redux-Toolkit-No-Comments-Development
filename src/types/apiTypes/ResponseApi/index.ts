...
// -> ta không sử dụng kiểu ResponseApi nữa, tách thành 2 interface ErrorResponseApi và SuccessResponseApi để handle rõ
// ràng cả 2 trường hợp response success và error
